...
class Codecheck():
    ...
    def title(self):
        ...
        directory.
        """
        return Markdown(f'''# CODECHECK certificate {self.conf['certificate']}{{-}}
...
'''
    ...
    def citation(self):
        ...
        """
        return Markdown(f"{self.conf['codechecker']['name']} "
...
'''
    ...
    def latex_figures(self, extensions=('.pdf', '.eps')):
        ...
        for entry in self.conf['manifest']:
            ...
            full_text.extend([r'\begin{figure}'
                              r'\texttt{' + fname.replace('_', r'\_') + r'}.\\',
